...
-(void)updateButtons {
    if (selectedPhotos.count > 0) {
        [self.photoLibraryBtn setTitle:@"Select photo" forState:UIControlStateNormal];
    } else {
